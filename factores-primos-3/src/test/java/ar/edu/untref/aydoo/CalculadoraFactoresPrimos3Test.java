...
public class CalculadoraFactoresPrimos3Test {
    ...
    public void presentaCorrectamenteLosFactoresPrimosDel1EnFormatoPretty() {
        ...
        String texto = CalculadoraFactoresPrimos3.formatearPretty(factores, "1");
    ...
    public void presentaCorrectamenteLosFactoresPrimosDel1EnFormatoQuiet() {
        ...
        String texto = CalculadoraFactoresPrimos3.formatearQuiet(factores);
    ...
    public void presentaCorrectamenteLosFactoresPrimosDel2EnFormatoPretty() {
        ...
        String texto = CalculadoraFactoresPrimos3.formatearPretty(factores, "2");
    ...
    public void presentaCorrectamenteLosFactoresPrimosDel40EnFormatoPretty() {
        ...
        String texto = CalculadoraFactoresPrimos3.formatearPretty(factores, "40");
